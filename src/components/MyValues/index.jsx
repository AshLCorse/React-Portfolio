      ...
      >
        ...
        >
          ...
          >
            ...
            <h2>Passion</h2>
            <Text className={classes.description} mt={30}>
              I am driven by a passion for web development and the ability to
              create meaningful and engaging experiences for my clients. I want
              to solve the puzzles and problems facing you!
            </Text>
            <h2>Honesty</h2>
            <Text className={classes.description} mt={30}>
              I believe in the power of honesty and transparency in my work. I
              will guide every customer through their options, and help you get
              the best website for your business!
            </Text>
            <h2>Leadership</h2>
            <Text className={classes.description} mt={30}>
              I am always looking for opportunities to teach others and help
              them find the right solution for their situation. I lead by
              example, and I will show you how I build your solution. 😊
            </Text>
            <Link to="/portfolio">
              <Button
                variant="gradient"
